(function ( $ ) {
	...
	$.fn.BootSideMenu = function( options ) {
		...
		newCode += "	<span class=\"fa fa-angle-double-right\">&nbsp;</span> <span class=\"fa fa-angle-double-left\">&nbsp;</span>\n";
		newCode += "</div>\n";
...
function toggleArrow(toggler, side){
	if(side=="left"){
		$(toggler).children(".fa-angle-double-right").css('display', 'block');
		$(toggler).children(".fa-angle-double-left").css('display', 'none');
	}else if(side=="right"){
		$(toggler).children(".fa-angle-double-left").css('display', 'block');
		$(toggler).children(".fa-angle-double-right").css('display', 'none');
	}
}
