...
<!-- 2nd page header -->
<div class="ordinaire-aboutus-header ordinaire-bgcolor-yellow">	
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h2 class="ordinaire-about-text text-trans ordinaire-color-darkgray">Portfolio</h2>
                <h1 class="ordinaire-we-text ordinaire-color-darkgray"> <?php echo get_post_custom_values("title_page")[0] == "" ? 'Stay Connected...' : get_post_custom_values("title_page")[0]; ?></h1>
            </div>
        </div>
    </div>
</div>
...
<div class="ordinaire-aboutus-header">	
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <?php if ($ab->publish == 0) : ?>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="ordinaire-box-portfolio  ordinaire-portfolio-box-hover" style="background-image: url( /wp-content/themes/ordinaire/assets/images/port-img.png );">
                            <div class="ordinaire-overlay ordinaire-overlay-projects">
                                <div class="ordinaire-text">
                                    <h3 class="ordinaire-fade-in-out" >ADD PROJECTS...</h3>
                                    <p class="ordinaire-show-hover"> The added projects will be appear here!</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <?php while ($loop->have_posts()) : $loop->the_post(); ?>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ordinaire-mt15">
                        <?php if (has_post_thumbnail()) { // check if the post has a Thumbnail assigned to it. ?>

                        <div class="ordinaire-box-portfolio ordinaire-portfolio-box-hover"
                        style="background-image: url( 
                            <?php esc_url(the_post_thumbnail_url()); ?>
                           );">
                           <div class="ordinaire-overlay ordinaire-overlay-projects">
                            <div class="ordinaire-text">
                                <h3><span class="ordinaire-fade-in-out" ><?php the_title(); ?></span></h3>
                                <div class="ordinaire-show-hover">
                                    <?php the_content(); ?>
                                </div>
                            </div>
                        </div>
