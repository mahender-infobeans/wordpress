	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding0" id="home">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center divheight" id="divtest">
					<p class="ordinaire-home-text home-text-margin"><span class="ordinaire-font48"><?php echo (get_option("homeheading")==""?"Theme ordinaire":get_option("homeheading")); ?></span>
						<p class="ordinaire-home-text">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 ordinaire-b-block ordinaire-home-background">
...
<div class="container-fluid ordinaire-home-background">
	<div class="row">
		<div id="mycarousel" class="carousel slide" data-ride="carousel">
			...
			<?php if ( $ab->publish == 0 ) :?>
				<div class="carousel-inner">
					<div class="item active ordinaire-img-back ordinaire-default-img ordinaire-parallex-slider">
						<div class="carousel-caption">
							<h3 class="ordinaire-font36">Los Angeles</h3>
							<p class="ordinaire-font26">LA is always so much fun! LA is always so much fun! LA is always so much fun! LA is always so much fun! LA is always so much fun! LA is always so much fun!</p>
						</div>
					</div>

					<div class="item ordinaire-img-back ordinaire-default-img ordinaire-parallex-slider">
						<div class="carousel-caption">
							<h3 class="ordinaire-font36">Chicago</h3>
							<p class="ordinaire-font26">Thank you, Chicago! LA is always so much fun! LA is always so much fun!</p>
						</div>
					</div>

					<div class="item ordinaire-img-back ordinaire-default-img ordinaire-parallex-slider">
						<div class="carousel-caption">
							<h3 class="ordinaire-font36">New York</h3>
							<p class="ordinaire-font26">We love the Big Apple! LA is always so much fun! LA is always so much fun!</p>
						</div>
					</div>
			...
			<div class="carousel-inner" role="listbox">
				...
				<?php foreach($slider as $slide): ?>
					...
					<div class="item ordinaire-img-back ordinaire-parallex-slider <?php echo ($count == 0) ? 'active' : ''; ?>"
						style="background-image: url(<?php echo esc_url(wp_get_attachment_url( get_post_thumbnail_id($slide->ID))); ?> )">

						<div class="carousel-caption">
							<h3 class="ordinaire-font36"><?php  echo $slider[$count]->post_title; ?></h3>
							<p class="ordinaire-font26"><?php  echo $slider[$count]->post_content; ?></p>
						</div>
					</div>
					<?php $count++; ?>
				<?php endforeach; ?>
...
<div class="container-fluid">
	...
	<?php if ( $ab->publish == 0 ) :?>
		<div class="container ordinaire-home-background">
			<div class="row">
				<div class="col-lg-4 col-md-4 ordinaire-b-head">
					<h2><b>OUR CONCERN</b></h2>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12 col-md-12 ordinaire-b-block">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ordinaire-parallax-2">
			</div>
		</div>
	<?php endif; ?>
	...
	<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ordinaire-parallax-1
