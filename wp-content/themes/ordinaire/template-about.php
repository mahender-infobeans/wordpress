...
<div class="ordinaire-aboutus-header ordinaire-about-back-color">	
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<h2 class="ordinaire-about-text ordinaire-text-trans">about us</h2>
				<h1 class="ordinaire-we-text"><?php echo get_post_custom_values("title_page")[0] == ""? "We're a Creative Team": get_post_custom_values("title_page")[0]; ?></h1>
			</div>
		</div>
	</div>
</div>
...
<div class="container-fluid pos-relative">
	...
	<div class="ordinaire-img1">
	</div>
	<div class="ordinaire-img2">
	</div>
	<div class="container">	
		...
		<div class="row">
			...
			<div class="tab-content">
				...
				$counter++;
				?>
				<div role="tabpanel" class="tab-pane tab-content responsive col-lg-10 col-md-10 col-lg-offset-1 col-md-offset-1 ordinaire-tab-box <?php echo ($counter == 1) ? 'active' : ''?>" id="post-<?php the_ID(); ?>">
					<?php the_content();?>
